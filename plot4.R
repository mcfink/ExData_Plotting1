...
par(mfcol = c(2,2))
plot(newdtest$newdt, newdtest$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
...
plot(newdtest$newdt, newdtest$Voltage, ylab = "Voltage", xlab = "datetime", type = "l")
plot(newdtest$newdt, newdtest$Global_reactive_power, ylab="Global_reactive_power", xlab = "datetime", type = "l")
dev.off()